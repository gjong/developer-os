...
This records plugin handling for the previous Hyprland desktop. Developer OS now uses KDE Plasma on Wayland via SDDM; see [ADR-0011](0011-kde-plasma-wayland-session.md).
