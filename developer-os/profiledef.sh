...
file_permissions=(
  ...
  ["/usr/local/bin/developer-os-update"]="0:0:755"
  ["/usr/local/bin/developer-os-bootstrap"]="0:0:755"
  ["/usr/local/bin/install-developer-os-theme.sh"]="0:0:755"
  ...
  ["/usr/local/share/developer-os/developer-os-update"]="0:0:755"
  ["/usr/local/share/developer-os/developer-os-bootstrap"]="0:0:755"
  ...
  ["/usr/local/share/developer-os/seed-plasma-theme.sh"]="0:0:755"
  ...
  ["/usr/share/applications/developer-os-bootstrap.desktop"]="0:0:644"
)
